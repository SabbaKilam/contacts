...
//ajax objext used to get csv file content from server
...
*/
function init(){
    var path = "https://googledrive.com/host/0B4HC-e3WTADpfndhQkpFWDY0NUxhRDZlRzVYcmF6aE9hSG9GOWtPSmdXUEF1NV9zYmhha0k/contacts/docs/contacts.csv";  
    resize();
